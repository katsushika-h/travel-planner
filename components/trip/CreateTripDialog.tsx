      ...
      {open && createPortal(
        <div className="fixed inset-0 z-[100] grid place-items-center bg-black/35 p-4" role="dialog" aria-modal="true">
          <form action={submit} className="w-full max-w-md rounded-xl border bg-background p-6 shadow-2xl">
            ...
            <label className="block text-sm font-medium">Trip name<input name="title" required placeholder="Japan spring escape" className="mt-1.5 w-full rounded-md border bg-background px-3 py-2" /></label>
