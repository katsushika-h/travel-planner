...
function WeekDayColumn({ date, items, allDayHeight, trip, typeColors, selectedIds, primarySelectedId, expandedChunk, onExpandedChange, onSelect, onResize, onSelectDay, onCreateItem }: { date: string; items: TravelObject[]; allDayHeight: number; trip: Trip; typeColors: Record<string, string>; selectedIds: ReadonlySet<string>; primarySelectedId: string | null; expandedChunk: string | null; onExpandedChange: (key: string | null) => void; onSelect: (item: TravelObject, additive?: boolean) => void; onResize: (item: TravelObject, edge: "start" | "end", time: string) => void; onSelectDay: () => void; onCreateItem: (date: string, order: number) => void }) {
