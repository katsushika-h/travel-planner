...
export function AppShell() {
  ...
  const { trips, setTrips, items, setItems, loadingTrips, itemsTripId, setItemsTripId, activeTrip } = useTripData(activeTripId, setActiveTripId, setError);
