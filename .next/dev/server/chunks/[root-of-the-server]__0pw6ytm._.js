...
async function GET() {
    const trips = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].trip.findMany({
        orderBy: [
            {
                startDate: "asc"
            },
...
async function POST(request) {
    try {
        ...
        const startDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readDate"])(body.startDate, "startDate", true);
        const endDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readDate"])(body.endDate, "endDate", true);
        ...
        const trip = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].trip.create({
            data: {
                ...
                startDate,
                endDate,
                timezone: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readTimeZone"])(body.timezone)
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0pw6ytm._.js.map