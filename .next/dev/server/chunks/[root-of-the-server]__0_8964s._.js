...
"[project]/app/api/travel-objects/[objectId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function readOptionalJson(value, field) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isRecord"])(value)) throw new Error(`${field} must be a JSON object or null.`);
    return value;
}
async function GET(_request, { params }) {
    const { objectId } = await params;
    const travelObject = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].travelObject.findUnique({
        where: {
            id: objectId
        }
    });
    return travelObject ? Response.json(travelObject) : Response.json({
        error: "Travel object not found."
    }, {
        status: 404
    });
}
async function PATCH(request, { params }) {
    try {
        ...
        if (body.notes !== undefined) {
            data.notes = body.notes === null ? null : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readTrimmedString"])(body.notes, "notes");
        }
        if (body.tags !== undefined) data.tags = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readTags"])(body.tags);
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].travelObject.findUnique({
            where: {
                id: objectId
            }
        });
        ...
        const travelObject = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].travelObject.update({
            where: {
                id: objectId
            },
            data
...
async function DELETE(_request, { params }) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].travelObject.delete({
        where: {
            id: objectId
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0_8964s._.js.map